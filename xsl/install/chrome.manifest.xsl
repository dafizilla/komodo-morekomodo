...
<xsl:apply-templates select="skins/skin[@name]" mode="chrome-manifest"/>
<xsl:text>
</xsl:text>

<!--<xsl:apply-templates select="components/component" mode="chrome-manifest"/>
...
<xsl:apply-templates select="resources/resource" mode="chrome-manifest"/>
